...
Status HadoopFileSystem::FileExists(const string& fname, std::unique_ptr<TransactionToken>* token) {
  hdfsFS fs = nullptr;
  TF_RETURN_IF_ERROR(Connect(fname, &fs));
...
Status HadoopFileSystem::DeleteFile(const string& fname, std::unique_ptr<TransactionToken>* token) {
  hdfsFS fs = nullptr;
  TF_RETURN_IF_ERROR(Connect(fname, &fs));
...
Status HadoopFileSystem::CreateDir(const string& dir, std::unique_ptr<TransactionToken>* token) {
  hdfsFS fs = nullptr;
  TF_RETURN_IF_ERROR(Connect(dir, &fs));
...
Status HadoopFileSystem::DeleteDir(const string& dir, std::unique_ptr<TransactionToken>* token) {
  hdfsFS fs = nullptr;
  TF_RETURN_IF_ERROR(Connect(dir, &fs));
...
Status HadoopFileSystem::GetFileSize(const string& fname, uint64* size, std::unique_ptr<TransactionToken>* token) {
  hdfsFS fs = nullptr;
  TF_RETURN_IF_ERROR(Connect(fname, &fs));
...
Status HadoopFileSystem::RenameFile(const string& src, const string& target, std::unique_ptr<TransactionToken>* token) {
  hdfsFS fs = nullptr;
...
Status HadoopFileSystem::Stat(const string& fname, FileStatistics* stats, std::unique_ptr<TransactionToken>* token) {
  hdfsFS fs = nullptr;
  TF_RETURN_IF_ERROR(Connect(fname, &fs));
